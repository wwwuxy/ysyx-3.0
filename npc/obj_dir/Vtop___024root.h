...
class Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT___axi_io_isu_axi_out_bits_rresp;
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__axi__DOT___Mem_rresp;
        CData/*0:0*/ top__DOT__axi__DOT___Mem_rvalid;
        CData/*0:0*/ top__DOT__axi__DOT___Mem_awready;
    };
    struct {
        CData/*0:0*/ top__DOT__axi__DOT___Mem_wready;
        CData/*0:0*/ top__DOT__axi__DOT___Mem_bresp;
        CData/*2:0*/ top__DOT__axi__DOT__state;
        CData/*0:0*/ top__DOT__axi__DOT__ifu_selected;
        CData/*0:0*/ top__DOT__axi__DOT__isu_selected;
        CData/*0:0*/ top__DOT__axi__DOT____Vcellinp__Mem__awvalid;
        CData/*0:0*/ top__DOT__axi__DOT____VdfgTmp_h4d7b9f9a__0;
        CData/*0:0*/ top__DOT__axi__DOT__Mem__DOT__bvalid;
    ...
    struct {
        ...
        IData/*31:0*/ top__DOT__axi__DOT____Vcellinp__Mem__len;
        IData/*31:0*/ top__DOT__axi__DOT____Vcellinp__Mem__araddr;
        IData/*31:0*/ top__DOT__axi__DOT__Mem__DOT__data_delay;
        IData/*31:0*/ top__DOT__axi__DOT__Mem__DOT__unnamedblk1__DOT__temp_data;
