...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+12,(vlSelf->top__DOT___exu_io_out_bits_mem_wr_en));
        bufp->chgIData(oldp+13,(((IData)(vlSelf->top__DOT__idu__DOT__Contorller__DOT___GEN_16)
                                                     ...
                                                     ((IData)(vlSelf->top__DOT__idu__DOT__Contorller__DOT___GEN_10)
                                                      ...
                                                      ((IData)(vlSelf->top__DOT__idu__DOT__Contorller__DOT___GEN_9)
                                                       ...
                                                       ((IData)(vlSelf->top__DOT__idu__DOT__Contorller__DOT___GEN_8)
                                                         ? 1U
                                                         : 4U))))))))),32);
        bufp->chgBit(oldp+14,(vlSelf->top__DOT___isu_io_isu_axi_out_bits_load_unsign));
        ...
        bufp->chgBit(oldp+23,((3U == (IData)(vlSelf->top__DOT__ifu__DOT__state))));
        bufp->chgIData(oldp+24,(vlSelf->top__DOT__xbar__DOT__io_isu_axi_out_bits_rdata_0),32);
        ...
        bufp->chgBit(oldp+73,(vlSelf->top__DOT__xbar__DOT__ifu_selected));
        bufp->chgBit(oldp+74,(vlSelf->top__DOT__ifu__DOT__valid));
        bufp->chgBit(oldp+75,(vlSelf->top__DOT__ifu__DOT__arvalid));
        bufp->chgBit(oldp+76,(vlSelf->top__DOT__xbar__DOT__io_isu_axi_out_bits_arready_0));
        bufp->chgBit(oldp+77,(((IData)(vlSelf->top__DOT__xbar__DOT__uart_selected)
                                ? (IData)(vlSelf->top__DOT__xbar__DOT__Uart__DOT__rvalid)
                                : (IData)(vlSelf->top__DOT__xbar__DOT___Sram_rvalid))));
        bufp->chgBit(oldp+78,(vlSelf->top__DOT__xbar__DOT__io_isu_axi_out_bits_rresp_0));
        bufp->chgIData(oldp+79,(vlSelf->top__DOT__ifu__DOT__IPC),32);
        bufp->chgIData(oldp+80,(vlSelf->top__DOT__ifu__DOT__IR),32);
        bufp->chgCData(oldp+81,(vlSelf->top__DOT__ifu__DOT__state),2);
        bufp->chgBit(oldp+82,((5U == (IData)(vlSelf->top__DOT__isu__DOT__state))));
        bufp->chgBit(oldp+83,(vlSelf->top__DOT__isu__DOT__load_finish));
        bufp->chgBit(oldp+84,(vlSelf->top__DOT__isu__DOT__store_finish));
        bufp->chgBit(oldp+85,(vlSelf->top__DOT__xbar__DOT__isu_selected));
        bufp->chgBit(oldp+86,(vlSelf->top__DOT__isu__DOT__valid));
        bufp->chgBit(oldp+87,(vlSelf->top__DOT__isu__DOT__arvalid));
        bufp->chgBit(oldp+88,(vlSelf->top__DOT__isu__DOT__awvalid));
        bufp->chgBit(oldp+89,(vlSelf->top__DOT__isu__DOT__wvalid));
        bufp->chgBit(oldp+90,(((IData)(vlSelf->top__DOT__xbar__DOT__uart_selected)
                                ? (IData)(vlSelf->top__DOT__xbar__DOT__Uart__DOT__awready)
                                : (IData)(vlSelf->top__DOT__xbar__DOT___Sram_awready))));
        bufp->chgBit(oldp+91,(((IData)(vlSelf->top__DOT__xbar__DOT__uart_selected)
                                ? (IData)(vlSelf->top__DOT__xbar__DOT__Uart__DOT__wready)
                                : (IData)(vlSelf->top__DOT__xbar__DOT___Sram_wready))));
        bufp->chgBit(oldp+92,(((IData)(vlSelf->top__DOT__xbar__DOT__uart_selected)
                                ? (IData)(vlSelf->top__DOT__xbar__DOT__Uart__DOT__bresp)
                                : (IData)(vlSelf->top__DOT__xbar__DOT___Sram_bresp))));
        bufp->chgCData(oldp+93,(vlSelf->top__DOT__isu__DOT__state),3);
        bufp->chgCData(oldp+94,(vlSelf->top__DOT__wbu__DOT__state),2);
        bufp->chgCData(oldp+95,(vlSelf->top__DOT__xbar__DOT__state),3);
        bufp->chgBit(oldp+96,(vlSelf->top__DOT__xbar__DOT__uart_selected));
        bufp->chgBit(oldp+97,(((~ (IData)(vlSelf->top__DOT__xbar__DOT__uart_selected)) 
                               & (IData)(vlSelf->top__DOT__xbar__DOT___Uart_io_in_bits_arvalid_T))));
        bufp->chgIData(oldp+98,(vlSelf->top__DOT__xbar__DOT____Vcellinp__Sram__araddr),32);
        bufp->chgBit(oldp+99,(((~ (IData)(vlSelf->top__DOT__xbar__DOT___GEN)) 
                               & (IData)(vlSelf->top__DOT___isu_io_isu_axi_out_bits_load_unsign))));
        bufp->chgIData(oldp+100,(vlSelf->top__DOT__xbar__DOT__Sram__DOT__data_delay),32);
        bufp->chgBit(oldp+101,(vlSelf->top__DOT__xbar__DOT___Sram_rresp));
        bufp->chgBit(oldp+102,(vlSelf->top__DOT__xbar__DOT___Sram_rvalid));
        bufp->chgBit(oldp+103,((1U & (~ (IData)(vlSelf->top__DOT__xbar__DOT__uart_selected)))));
        bufp->chgBit(oldp+104,(vlSelf->top__DOT__xbar__DOT____Vcellinp__Sram__awvalid));
        bufp->chgBit(oldp+105,(vlSelf->top__DOT__xbar__DOT___Sram_awready));
        bufp->chgBit(oldp+106,(((~ (IData)(vlSelf->top__DOT__xbar__DOT___GEN)) 
                                & (IData)(vlSelf->top__DOT__isu__DOT__wvalid))));
        bufp->chgIData(oldp+107,(((IData)(vlSelf->top__DOT__xbar__DOT___GEN)
                                   ? 0U : vlSelf->top__DOT__idu__DOT___RegisterFile_io_rd2)),32);
        bufp->chgIData(oldp+108,(vlSelf->top__DOT__xbar__DOT____Vcellinp__Sram__len),32);
        bufp->chgBit(oldp+109,(vlSelf->top__DOT__xbar__DOT___Sram_wready));
        bufp->chgBit(oldp+110,(vlSelf->top__DOT__xbar__DOT___Sram_bresp));
        bufp->chgBit(oldp+111,(vlSelf->top__DOT__xbar__DOT__Sram__DOT__bvalid));
        bufp->chgIData(oldp+112,(vlSelf->top__DOT__xbar__DOT__Sram__DOT__unnamedblk1__DOT__temp_data),32);
        bufp->chgBit(oldp+113,(((IData)(vlSelf->top__DOT__xbar__DOT__uart_selected) 
                                & (IData)(vlSelf->top__DOT__xbar__DOT___Uart_io_in_bits_arvalid_T))));
        bufp->chgIData(oldp+114,(vlSelf->top__DOT__xbar__DOT____Vcellinp__Uart__io_in_bits_araddr),32);
        bufp->chgBit(oldp+115,(((IData)(vlSelf->top__DOT__xbar__DOT____VdfgTmp_h15661469__0) 
                                & (IData)(vlSelf->top__DOT__isu__DOT__awvalid))));
        bufp->chgIData(oldp+116,(vlSelf->top__DOT__xbar__DOT____Vcellinp__Uart__io_in_bits_awaddr),32);
        bufp->chgBit(oldp+117,(vlSelf->top__DOT__xbar__DOT____Vcellinp__Uart__io_in_bits_wvalid));
        bufp->chgIData(oldp+118,(((IData)(vlSelf->top__DOT__xbar__DOT___GEN_0)
                                   ? 0U : vlSelf->top__DOT__idu__DOT___RegisterFile_io_rd2)),32);
        bufp->chgBit(oldp+119,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__arready));
        bufp->chgBit(oldp+120,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__rvalid));
        bufp->chgIData(oldp+121,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__rdata),32);
        bufp->chgBit(oldp+122,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__rresp));
        bufp->chgBit(oldp+123,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__awready));
        bufp->chgBit(oldp+124,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__wready));
        bufp->chgBit(oldp+125,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__bresp));
        bufp->chgIData(oldp+126,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__deviceReg),32);
        bufp->chgQData(oldp+127,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__mtime),64);
        bufp->chgBit(oldp+129,(vlSelf->top__DOT__xbar__DOT__Uart__DOT__bvalid));
    }
    bufp->chgBit(oldp+130,(vlSelf->clock));
    bufp->chgBit(oldp+131,(vlSelf->reset));
    bufp->chgIData(oldp+132,(vlSelf->io_pc),32);
    bufp->chgIData(oldp+133,(vlSelf->io_alu_rsl),32);
    bufp->chgIData(oldp+134,(vlSelf->io_inst),32);
    bufp->chgIData(oldp+135,(vlSelf->io_imm),32);
    bufp->chgBit(oldp+136,(vlSelf->io_diff_test));
    bufp->chgBit(oldp+137,(vlSelf->io_wbu_valid));
    bufp->chgIData(oldp+138,(((IData)(vlSelf->top__DOT__xbar__DOT___GEN)
