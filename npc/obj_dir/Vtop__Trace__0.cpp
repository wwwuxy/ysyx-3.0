...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+0,(vlSelf->top__DOT___Controller_io_rf_wr_en));
        bufp->chgBit(oldp+1,(vlSelf->top__DOT___Controller_io_alu_a_sel));
        bufp->chgBit(oldp+2,(vlSelf->top__DOT___Controller_io_jump_en));
    }
    ...
    bufp->chgIData(oldp+43,(vlSelf->io_imm),32);
