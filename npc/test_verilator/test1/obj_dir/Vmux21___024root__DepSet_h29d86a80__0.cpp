...
VL_INLINE_OPT void Vmux21___024root___ico_sequent__TOP__0(Vmux21___024root* vlSelf) {
    ...
    // Body
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__hit = ((IData)(vlSelf->s) 
                                                 == 
                                                 vlSelf->mux21__DOT__i0__DOT__i0__DOT__key_list
                                                 [0U]);
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__hit = ((IData)(vlSelf->mux21__DOT__i0__DOT__i0__DOT__hit) 
                                                 | ((IData)(vlSelf->s) 
                                                    == 
                                                    vlSelf->mux21__DOT__i0__DOT__i0__DOT__key_list
                                                    [1U]));
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__pair_list[0U] 
        = (2U | (IData)(vlSelf->b));
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__pair_list[1U] 
        = vlSelf->a;
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__data_list[0U] 
        = vlSelf->b;
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__data_list[1U] 
        = vlSelf->a;
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__lut_out = 
        (((IData)(vlSelf->s) == vlSelf->mux21__DOT__i0__DOT__i0__DOT__key_list
          [0U]) & vlSelf->mux21__DOT__i0__DOT__i0__DOT__data_list
         [0U]);
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__lut_out = 
        ((IData)(vlSelf->mux21__DOT__i0__DOT__i0__DOT__lut_out) 
         | (((IData)(vlSelf->s) == vlSelf->mux21__DOT__i0__DOT__i0__DOT__key_list
             [1U]) & vlSelf->mux21__DOT__i0__DOT__i0__DOT__data_list
            [1U]));
    vlSelf->y = vlSelf->mux21__DOT__i0__DOT__i0__DOT__lut_out;
}
...
#endif
                VL_FATAL_MT("mux21.v", 57, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("mux21.v", 57, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("mux21.v", 57, "", "NBA region did not converge.");
            }
