...
#endif
                VL_FATAL_MT("mux21.v", 57, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vmux21___024root___ctor_var_reset(Vmux21___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->mux21__DOT__i0__DOT__i0__DOT__pair_list[__Vi0] = VL_RAND_RESET_I(2);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
    ...
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__lut_out = VL_RAND_RESET_I(1);
    vlSelf->mux21__DOT__i0__DOT__i0__DOT__hit = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
