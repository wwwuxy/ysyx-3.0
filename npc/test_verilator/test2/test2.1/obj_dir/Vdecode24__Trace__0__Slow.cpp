...
VL_ATTR_COLD void Vdecode24___024root__trace_init_sub__TOP__0(Vdecode24___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->pushNamePrefix("decode24 ");
    tracep->declBus(c+1,"x", false,-1, 1,0);
    tracep->declBit(c+2,"en", false,-1);
    tracep->declBus(c+3,"y", false,-1, 3,0);
...
VL_ATTR_COLD void Vdecode24___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vdecode24___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vdecode24___024root__trace_register(Vdecode24___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->addFullCb(&Vdecode24___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&Vdecode24___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&Vdecode24___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vdecode24___024root__trace_full_sub_0(Vdecode24___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vdecode24___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode24___024root__trace_full_top_0\n"); );
    // Init
    Vdecode24___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vdecode24___024root*>(voidSelf);
    Vdecode24__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vdecode24___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vdecode24___024root__trace_full_sub_0(Vdecode24___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vdecode24__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode24___024root__trace_full_sub_0\n"); );
    // Init
    ...
    bufp->fullIData(oldp+4,(vlSelf->decode24__DOT__i),32);
}
