...
VL_ATTR_COLD void Vencode83___024root__trace_init_sub__TOP__0(Vencode83___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,"led_out", false,-1, 2,0);
    tracep->declBus(c+7,"light", false,-1, 6,0);
    tracep->declBit(c+8,"a", false,-1);
    ...
    tracep->declBus(c+7,"light", false,-1, 6,0);
    tracep->declBit(c+8,"a", false,-1);
    tracep->declBus(c+1,"w", false,-1, 2,0);
    tracep->pushNamePrefix("encrd ");
    tracep->declBus(c+4,"x", false,-1, 7,0);
    tracep->declBit(c+5,"en", false,-1);
    tracep->declBus(c+1,"y", false,-1, 2,0);
    tracep->declBit(c+8,"a", false,-1);
...
VL_ATTR_COLD void Vencode83___024root__trace_full_sub_0(Vencode83___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+1,(vlSelf->top__DOT__w),3);
    bufp->fullIData(oldp+2,(vlSelf->top__DOT__encrd__DOT__i),32);
    bufp->fullCData(oldp+3,(vlSelf->top__DOT__w),4);
    bufp->fullCData(oldp+4,(vlSelf->x),8);
    bufp->fullBit(oldp+5,(vlSelf->en));
    bufp->fullCData(oldp+6,(vlSelf->led_out),3);
    bufp->fullCData(oldp+7,(vlSelf->light),7);
    bufp->fullBit(oldp+8,(vlSelf->a));
}
